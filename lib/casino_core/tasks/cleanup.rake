...
namespace :casino_core do
  namespace :cleanup do
    ...
    task service_tickets: 'casino_core:db:configuration' do
    ...
    task proxy_tickets: 'casino_core:db:configuration' do
      [:consumed, :unconsumed].each do |type|
    ...
    task login_tickets: 'casino_core:db:configuration' do
    ...
    task two_factor_authenticators: 'casino_core:db:configuration' do
    ...
    task ticket_granting_tickets: 'casino_core:db:configuration' do
